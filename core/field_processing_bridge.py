...
# The field workbench should not expose spacing-changing acquisition utilities in
# the main processing page.  They remain in the registry for existing callers.
HIDDEN_FIELD_METHOD_IDS = {"equidistant_trace_resample"}
...
def run_registered_method(
    ...
    *,
    ...
    result, result_meta = run_processing_method(dataset.matrix, method_id, runtime_params)
    ...
    manifest = {
        ...
        "input_data_sha256": _array_sha256(dataset.matrix),
        "output_data_sha256": _array_sha256(output.matrix),
