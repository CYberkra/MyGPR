...
PROCESSING_METHODS_BACKGROUND_DENOISE = {
    ...
    "wavelet_2d": {
            ...
            "params": [
                ...
                {
                    "name": "threshold",
                    "label": "Threshold (VisuShrink multiplier, 0-1)",
                    "type": "float",
                    "default": 1.0,
                    "min": 0.0,
                    "max": 1.0,
    ...
    "wavelet_svd": {
            ...
            "params": [
                ...
                },
                {
                    ...
                    "default": "keep",
                    "choices": ["keep", "remove"],
                    "tooltip": "keep=保留第一主分量（默认）；remove=剔除第一主分量（直达波/背景趋势）。",
                },
            ],
            "auto_tune_enabled": HAS_PYWAVELETS,
            "auto_tune_family": "denoise",
    ...
    "ccbs": {
            ...
            "params": [
                ...
                {
                    "name": "reference_trace_index",
                    "label": "参考道号 (0-based, -1=不使用)",
                    "type": "int",
                    "default": -1,
                    "min": -1,
                    "tooltip": "指定某一道作为参考回波；-1 表示不使用参考道。",
                },
            ],
        },
}
