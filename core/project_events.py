...
class ProjectEventType:
    ...
    # ``TARGETS_*`` names are retained for backward compatibility with old
    # point-target projects.  New basal-interface code emits the annotation
    # names below so the five-page workflow uses domain-correct terminology.
    TARGETS_CHANGED = "TARGETS_CHANGED"
    TARGET_SELECTED = "TARGET_SELECTED"
    ANNOTATION_SAVED = "ANNOTATION_SAVED"
    ANNOTATION_CONFIRMED = "ANNOTATION_CONFIRMED"
    SPATIAL_RESULT_SELECTED = "SPATIAL_RESULT_SELECTED"
