...
- GPU remains an optional acceleration path; current PowerShell/Codex-shell diagnosis indicates the host toolchain can fail when the MSVC compiler environment is not loaded.
...
- GUI integration is still not implemented.
